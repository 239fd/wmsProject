...
-- G-3: Справочник поставщиков (глобальный, без привязки к организации)
...
-- G-2: Поставки с жизненным циклом
...
-- B3: Персистентное состояние Saga
...
-- C5/G-1: RPA-экстрактор плановых поставок из ERP
